        ...
        <div className="fs">
          <ol type="i">
            <li>
              ...
              <h2>
                ...
                <span className="p-6 text-start">
                  <span>Web AI</span> <br /> <span className="ml-12">working ex</span>
                </span>
              </h2>
              <button
                style={{
            ...
            <li>
              ...
              <hr />
              <h2>
                2 <span>Robots Learn to</span> <br /> <span className="ml-8">walk in just days</span>
              </h2>
              <button
                style={{
                  display: "flex",
            ...
            <li>
              ...
              <hr />
              <h2>
                3 <span>Why Robots Might be the</span> <br /> <span className="ml-8">Future of work</span>
              </h2>
              <button
                style={{
                  display: "flex",
